...
var templateFolderName = "abacusmine_2.0.6",
...
$(document).ready(function () {
	...
	var contentRules = [
		{
			...
			content: '<div class="login-logo"><img src="' + subFolder + '/themes/'+templateFolderName+'/images/logo.png" /></div>',
			insert: 'before',
			if: showLogoLogin, 
		},
		{
  ...
  //TODO moze byt v CSS
	...
	/*Agile*/	
	$('.agile-board').append('<span class="esc"><strong>Esc </strong> = Exit Fullscreen');
